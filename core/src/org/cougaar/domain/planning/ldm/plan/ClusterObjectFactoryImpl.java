...
public class ClusterObjectFactoryImpl implements ClusterObjectFactory {
  ...
  public Policy newPolicy( String policyType ) {
     ...
     if (policyType.indexOf('.') == -1)
       className = "org.cougaar.domain.planning.ldm.policy." + policyType;
  ...
  /** @deprecated Use org.cougaar.domain.planning.ldm.plan.Verb constructor instead **/
   ...
   * @see org.cougaar.domain.planning.ldm.plan.AssignedAvailabilityElement 
   **/
