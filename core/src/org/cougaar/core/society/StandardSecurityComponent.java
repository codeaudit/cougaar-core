 ...
 * Supports old properties org.cougaar.core.security.manager and org.cougaar.domain.manager for
  ...
  extends SecurityComponent
{
  ...
  public void load() {
    ...
    { 
      String foo = System.getProperty("org.cougaar.domain.manager");
      if (foo != null) {
        System.err.println("Warning! org.cougaar.domain.manager is obsolete: use org.cougaar.core.security.Domain!");
        if (dmId == null) {
          dmId = foo;
        } else {
          //System.exit(-1);
