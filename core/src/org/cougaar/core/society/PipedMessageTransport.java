...
public class PipedMessageTransport extends MessageTransport
{
  ...
  protected void sendMessageToSociety(Message m) {
    ...
    // short-circuit local delivery when requested.
    if (useLocalDelivery && address.equals(m.getOriginator())) receiveMessage(m);
