    ...
    implements ResourceMonitorService
{
    ...
    // Observables can be generated by BBN QuO RSS
    // Note that this is not in MJIPS
    public Observable getExpectedMaxJipsForAgentObservable(MessageAddress agentAddress) {
	return null;
    }

    //Sysconds are used in BBN QuO Kernel
    public Object getExpectedMaxMJipsForAgentSyscond(MessageAddress agentAddress) {
	return null;
    }
    ...
    //Sysconds are used in BBN QuO Kernel
    public Object getExpectedEffectiveMJipsForAgentSyscond(MessageAddress agentAddress) {
	return null;
    }
    ...
    //Sysconds are used in BBN QuO Kernel
    public Object getExpectedBandwidthForAgentSyscond(MessageAddress agentAddress) {
	return null;
    }
    ...
    //Sysconds are used in BBN QuO Kernel
    public Object getExpectedCapacityForAgentSyscond(MessageAddress agentAddress) {
	return null;
    }
