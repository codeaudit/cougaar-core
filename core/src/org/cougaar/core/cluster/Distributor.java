...
public class Distributor {
  ...
  public void setWhiteboard(Whiteboard alpPlan) {
   ...
   * fill from the Whiteboard (alpPlan.fillSubscription).
   **/
   ...
   * flag. Any messages generated by the Whiteboard are gathered and
   ...
   * Whiteboard for processing. Envelopes resulting from that processing
   * are distributed.
   **/
