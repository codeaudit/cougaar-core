 ...
 * @see ABMTransportLP
 */
public final class ABMAddress extends ClusterIdentifier {

  /** only for infrastructure **/
  public ABMAddress() {}

  public ABMAddress( String address ) {
    super(address);
    cacheABMAddress(address, this);
  }
  ...
  protected Object readResolve() {
    return getABMAddress(new String(addressBytes));
  }

  // Helper methods to ensure efficiencey follow

  private static java.util.HashMap cache = new java.util.HashMap(89);
  public static ABMAddress getABMAddress(String as) {
    synchronized (cache) {
      ABMAddress a = (ABMAddress) cache.get(as);
      if (a != null) 
        return a;
      else
        return new ABMAddress(as.intern());    // calls cacheABMAddress
    }
  }

  public static void cacheABMAddress(String as, ABMAddress a) {
    synchronized (cache) {
      cache.put(as, a);
    }
  }
